...
router.get('/store/:storeId', async(req, res) => {
    try {
        ...
        return ApiResponse.success(res, 'Store products retrieved successfully', { products })
    } catch (error) {
...
router.get('/category/:category', async(req, res) => {
    try {
        ...
        return ApiResponse.success(res, 'Category products retrieved successfully', { products })
    } catch (error) {
